...
const docs: SearchDocument[] = [
  { id: 'a', setCode: 'BS', number: '1', name: 'Harry Potter', text: null, flavorText: null, types: ['character'], subTypes: [], lesson: null, rarity: 'rare', finishes: ['normal'], legality: 'legal', cost: null, isOfficial: true, imageLang: 'en', defaultLanguage: 'en' },
  { id: 'b', setCode: 'BS', number: '2', name: 'Flobberworm', text: null, flavorText: null, types: ['creature'], subTypes: [], lesson: null, rarity: 'common', finishes: ['normal'], legality: 'legal', cost: 2, isOfficial: false, imageLang: null, defaultLanguage: 'en' },
]
