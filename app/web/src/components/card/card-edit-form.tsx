...
import { LocalizationForm, type LocalizationFormHandle } from '@/components/card/localization-form'
import { RulingsEditor, type RulingsEditorHandle } from '@/components/card/rulings-editor'
