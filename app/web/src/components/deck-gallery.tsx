...
export function DeckGallery({ entries, imageBase }: { entries: DeckCardView[]; imageBase: string }) {
  ...
  return (
    <div className="space-y-4">
      <section>
        <h3 className="mb-2 text-xs font-semibold tracking-widest text-primary-ink uppercase">{t('panel.character')}</h3>
        {character.length === 0 ? (
      ...
      <section>
        <h3 className="mb-2 flex items-center gap-2 text-xs font-semibold tracking-widest text-primary-ink uppercase">
