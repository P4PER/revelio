...
describe('text export', () => {
  it('groups by zone with a header and counts', () => {
    const views: DeckCardView[] = [
      { cardId: 'HARRY', zone: 'character', quantity: 1, name: 'Harry Potter', cost: null, damage: null, types: ['character'], setCode: 'BS', number: '1', lesson: null, isOfficial: true, legality: 'legal', isLesson: false, isStartingCharacter: true },
      { cardId: 'da-accio', zone: 'main', quantity: 4, name: 'Accio', cost: 2, damage: null, types: ['spell'], setCode: 'DA', number: '12', lesson: 'charms', isOfficial: true, legality: 'legal', isLesson: false, isStartingCharacter: false },
    ]
