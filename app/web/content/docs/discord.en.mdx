...
disconnecting your account, [privacy and limits](/docs/discord/privacy) sets out
exactly what the bot can and cannot see, and
[troubleshooting](/docs/discord/troubleshooting) covers what to try when a
command does not behave.
