...
// such a card we render a landscape frame (aspect-[7/5]) and rotate the image to
// fill it. Sized to the rotated-vertical dimensions by the caller, the upright
// card ends up the same size as a vertical card that has been turned on its side.
